...
<div class="w-full xl:w-2/3 block px-10 bg-white rounded-xl py-5 shadow-md">
    ...
    <div class="flex justify-between py-3 mx-5">
        <span class="text-xl font-semibold text-gray-700">Add Website</span>
    ...
    <form action="{{ route('admin.website.store') }}" method="POST">
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <input name="website_name" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter Website Name" />
                @error('website_name')
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <input name="website_link" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter Website Link" />
                @error('website_link')
                <span class="bg-red-500 px-3 py-1 text-xs text-white font-semibold rounded-full">{{ $message }}</span>
                @enderror
            </div>
