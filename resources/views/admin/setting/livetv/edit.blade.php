    ...
    <form action="{{ route('admin.livetv.update', $livetv->id) }}" method="POST">
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            <div class="mb-1 md:mb-0 md:w-1/3">
                <label class="text-gray-800 font-bold">Embed Code for Live TV</label>
            </div>
            <div class="md:w-2/3 md:flex-grow">
                <textarea id="summernote" name="embed_code" class="autoexpand tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                 type="text">{{ $livetv->embed_code }}</textarea>
