    ...
    <form action="{{ route('admin.video.store') }}" method="POST" >
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <textarea name="embed_code" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter embded code" /></textarea>
                @error('embed_code')
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <input name="title_en" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter EN Category Name" />
                @error('title_en')
                <span class="bg-red-500 px-3 py-1 text-xs text-white font-semibold rounded-full">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <input name="title_mk" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter MK Category Name" />
                @error('title_mk')
                <span class="bg-red-500 px-3 py-1 text-xs text-white font-semibold rounded-full">{{ $message }}</span>
                @enderror
            </div>
