...
<div class="w-full xl:w-2/3 block px-10 bg-white rounded-xl py-5 shadow-md">
    ...
    <div class="flex justify-between py-3 mx-5">
        <span class="text-xl font-semibold text-gray-700">Create SubCategory</span>
    ...
    <form action="{{ route('admin.subcategory.store') }}" method="POST">
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <input name="subcategory_en" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter EN SubCategory Name" />
        ...
        <div class="text-gray-700 md:flex md:items-center p-4">
            ...
            <div class="md:w-2/3 md:flex-grow">
                <input name="subcategory_mk" class="w-full h-10 px-3 text-sm placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="Enter MK SubCategory Name" />
