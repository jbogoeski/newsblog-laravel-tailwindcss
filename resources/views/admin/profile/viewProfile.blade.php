    ...
    <div class="w-full md:w-3/5 p-8 bg-white lg:ml-4 shadow-md rounded-md">
      <div class="rounded  shadow p-6">
        <div class="pb-6">
          ...
          <div class="flex">
            <input disabled id="username" class="border-1  rounded-r px-4 py-2 w-full" type="text" value="{{ $adminData->name }}" />
          </div>
        </div>
        <div class="pb-4">
          <label for="about" class="font-semibold text-gray-700 block pb-1">Email</label>
          <input disabled id="email" class="border-1  rounded-r px-4 py-2 w-full" type="email" value="{{ $adminData->email }}" />
